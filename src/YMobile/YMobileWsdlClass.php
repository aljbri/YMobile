 ...
 * @package YMobile
 */
class YMobileWsdlClass extends \stdClass implements \ArrayAccess,\Iterator,\Countable
{
    /**
     * @var string
     */
     ...
     * @var string
     */
    const VALUE_WSDL_URL = 'http://www.srapstudio.com/huawei/BankInterface.wsdl';
    /**
    ...
    /**
     * Soapclient called to communicate with the actual SOAP Services
     * @var SoapClient
     */
    ...
    /**
     * Constructor
     * @uses YMobileWsdlClass::setLastError()
     * @uses YMobileWsdlClass::initSoapClient()
     * @uses YMobileWsdlClass::initInternArrayToIterate()
     * @uses YMobileWsdlClass::_set()
    ...
    public static function __set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'YMobileWsdlClass'))
            {
    ...
    public function initSoapClient($_wsdlOptions)
    {
        ...
        foreach ($defaultWsdlOptions as $optioName => $optionValue) {
            if (array_key_exists($optioName, $_wsdlOptions) && !empty($options[$optioName])) {
     ...
     * If a class is named as {YMobile}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('YMobileSoapClient') && is_subclass_of('YMobileSoapClient','SoapClient'))
            return 'YMobileSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses YMobileWsdlClass::WSDL_CACHE_WSDL
     * @uses YMobileWsdlClass::WSDL_COMPRESSION
     * @uses YMobileWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses YMobileWsdlClass::WSDL_ENCODING
     * @uses YMobileWsdlClass::WSDL_EXCEPTIONS
     * @uses YMobileWsdlClass::WSDL_FEATURES
     * @uses YMobileWsdlClass::WSDL_LOGIN
     * @uses YMobileWsdlClass::WSDL_PASSWORD
     * @uses YMobileWsdlClass::WSDL_SOAP_VERSION
     * @uses YMobileWsdlClass::WSDL_STREAM_CONTEXT
     * @uses YMobileWsdlClass::WSDL_TRACE
     * @uses YMobileWsdlClass::WSDL_TYPEMAP
     * @uses YMobileWsdlClass::WSDL_URL
     * @uses YMobileWsdlClass::VALUE_WSDL_URL
     * @uses YMobileWsdlClass::WSDL_USER_AGENT
     * @uses YMobileWsdlClass::WSDL_PROXY_HOST
     * @uses YMobileWsdlClass::WSDL_PROXY_PORT
     * @uses YMobileWsdlClass::WSDL_PROXY_LOGIN
     * @uses YMobileWsdlClass::WSDL_PROXY_PASSWORD
     * @uses YMobileWsdlClass::WSDL_LOCAL_CERT
     * @uses YMobileWsdlClass::WSDL_PASSPHRASE
     * @uses YMobileWsdlClass::WSDL_AUTHENTICATION
     * @uses YMobileWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses YMobileWsdlClass::getSoapClient()
     * @uses YMobileWsdlClass::getFormatedXml()
     ...
     * @uses YMobileWsdlClass::getSoapClient()
     * @uses YMobileWsdlClass::convertStringHeadersToArray()
     ...
     * @uses YMobileWsdlClass::getInternArrayToIterate()
     * @uses YMobileWsdlClass::getInternArrayToIterateIsArray()
     * @return int
     */
     ...
     * @uses YMobileWsdlClass::offsetGet()
     * @return mixed
     */
     ...
     * @uses YMobileWsdlClass::getInternArrayToIterateOffset()
     * @uses YMobileWsdlClass::setInternArrayToIterateOffset()
     * @return int
     */
     ...
     * @uses YMobileWsdlClass::getInternArrayToIterateOffset()
     * @uses YMobileWsdlClass::offsetExists()
     * @return bool true|false
     */
     ...
     * @see YMobileWsdlClass::offsetGet()
     * @uses YMobileWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses YMobileWsdlClass::getAttributeName()
     * @uses YMobileWsdlClass::__toString()
     * @uses YMobileWsdlClass::_set()
     * @uses YMobileWsdlClass::_get()
     * @uses YMobileWsdlClass::setInternArrayToIterate()
     * @uses YMobileWsdlClass::setInternArrayToIterateIsArray()
     * @uses YMobileWsdlClass::setInternArrayToIterateOffset()
