...
/**
 * File for class YMobilePaymentResult
 * This class stands for YMobilePaymentResult originally named PaymentResult
 * Meta informations extracted from the WSDL
 * - from schema : {@link http://khedmatk.tk:90//BankInterface.xsd}
 * @package YMobile
 * @subpackage Structs
 */
class YMobilePaymentResult extends YMobileWsdlClass
{
    /**
     * The TranSerialNo
     * Meta informations extracted from the WSDL
