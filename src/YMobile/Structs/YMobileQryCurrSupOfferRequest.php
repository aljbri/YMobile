...
/**
 * File for class YMobileQryCurrSupOfferRequest
 * This class stands for YMobileQryCurrSupOfferRequest originally named QryCurrSupOfferRequest
 * Meta informations extracted from the WSDL
 * - from schema : {@link http://khedmatk.tk:90//BankInterface.xsd}
 * @package YMobile
 * @subpackage Structs
 */
class YMobileQryCurrSupOfferRequest extends YMobileWsdlClass
{
    /**
     * The SubscriberNo
     * Meta informations extracted from the WSDL
    ...
    public $SubscriberNo;
    /**
     * Constructor method for QryCurrSupOfferRequest
