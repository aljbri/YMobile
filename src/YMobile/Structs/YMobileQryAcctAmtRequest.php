...
/**
 * File for class YMobileQryAcctAmtRequest
 * This class stands for YMobileQryAcctAmtRequest originally named QryAcctAmtRequest
 * Meta informations extracted from the WSDL
 * - from schema : {@link http://khedmatk.tk:90//BankInterface.xsd}
 * @package YMobile
 * @subpackage Structs
 */
class YMobileQryAcctAmtRequest extends YMobileWsdlClass
{
    /**
     * The SubscriberNo
     * Meta informations extracted from the WSDL
    ...
    public $SubscriberNo;
    /**
     * Constructor method for QryAcctAmtRequest
