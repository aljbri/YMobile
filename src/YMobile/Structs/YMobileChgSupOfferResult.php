...
/**
 * File for class YMobileChgSupOfferResult
 * This class stands for YMobileChgSupOfferResult originally named ChgSupOfferResult
 ...
 * @date 2015-11-10
 */
class YMobileChgSupOfferResult extends YMobileWsdlClass
{
    /**
     * The SubscriberNo
     * Meta informations extracted from the WSDL
    ...
    public $SubscriberNo;
    /**
     * Constructor method for ChgSupOfferResult
