...
/**
 * File for class YMobileQryCustInfoRequest
 * This class stands for YMobileQryCustInfoRequest originally named QryCustInfoRequest
 ...
 * @date 2015-11-10
 */
class YMobileQryCustInfoRequest extends YMobileWsdlClass
{
    /**
     * The SubscriberNo
     * Meta informations extracted from the WSDL
    ...
    public $SubscriberNo;
    /**
     * Constructor method for QryCustInfoRequest
